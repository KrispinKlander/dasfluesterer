...
/* ------------------- USART ------------------- */
#define USART2_SR *(unsigned char*)0x5240
#define USART2_DR *(unsigned char*)0x5241
#define USART2_BRR1 *(unsigned char*)0x5242
#define USART2_BRR2 *(unsigned char*)0x5243
#define USART2_CR1 *(unsigned char*)0x5244
#define USART2_CR2 *(unsigned char*)0x5245
#define USART2_CR3 *(unsigned char*)0x5246
#define USART2_CR4 *(unsigned char*)0x5247
#define USART2_CR5 *(unsigned char*)0x5248
#define USART2_CR6 *(unsigned char*)0x5249
#define USART2_GTR *(unsigned char*)0x524A
#define USART2_PSCR *(unsigned char*)0x524B
